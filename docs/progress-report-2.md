...
| Final presentation quality | Not finished | Figures, screenshots, and polished formatting still need work |
...
This was a useful test for me because the resulting path showed that the search could avoid the building column and still reach a high-altitude goal.
...
At the moment, this report focuses mainly on implementation and early measurements. I have not included a UI screenshot yet, but I think adding one later would strengthen the final version of the report. A screenshot would be especially useful for showing:
...
4. capture screenshots and figures for the report and demo
